...
<table cellpadding="5" cellspacing="8" border="0" width="100%" class="fs12">
    ...
    <tr>
        ...
        <td width="auto" align="left"><input type="text" class="sl" name="url" value="',htmlspecialchars(stripslashes($cur_user['url'])),'" /> http://...</td>
    </tr>
    <tr>
...
<table cellpadding="5" cellspacing="8" border="0" width="100%" class="fs12">
    ...
    <tr>
        ...
        <td width="auto" align="left">你可以QQ登录，同时也可以使用你的用户名和设置的密码登录</td>
    </tr>
    <tr>
