...
<div class="post-list">';
if($m_obj['avatar'])
    echo '<div class="item-avatar"><a href="/member/',$m_obj['id'],'"><img src="',$options['base_avatar_url'],'/',$m_obj['avatar'],'.mini.jpg" alt="',$m_obj['name'],'" /></a></div>';
else
    echo '<div class="item-avatar"><a href="/member/',$m_obj['id'],'"><img src="/avatar/0.mini.jpg" alt="',$m_obj['name'],'" /></a></div>';
echo '
